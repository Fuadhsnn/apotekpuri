        ...
        <div class="container">
            ...
            <div class="services-grid">
                ...
                <div class="service-card">
                    ...
                    <p>Layanan konsultasi dan pembelian obat dengan kualitas terbaik</p>
                    <div class="service-features">
                        <span><i class="fas fa-check"></i>Layanan Terbaik</span>
                        <span><i class="fas fa-check"></i>Konsultasi Gratis</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="products" id="products">
        <div class="container">
            ...
            <div class="search-section">
                <div class="search-container">
                    <div class="search-box">
                        ...
                        <input type="text" id="searchInput" placeholder="Cari nama obat, kategori, atau kode..."
                            class="search-input">
            ...
            <div class="products-container">
                <div class="products-grid" id="productsGrid" style="max-height: 500px; overflow-y: auto;">
